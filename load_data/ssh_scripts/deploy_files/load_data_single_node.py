...
def load_data(year_list, month_list, day_list, schema_dictionary, spark_session, spark_context, mongodb_database, mongodb_collection, download_csv_path, start_url):
    ...
    for mention_csv_file in mentions_extracted_csvs:
        ...
        mentions_df = select_columns_df(mentions_df, df_type='mentions')         .withColumn('MentionDocTranslationInfo', regexp_extract('MentionDocTranslationInfo', r'srclc:([a-z]{3})*', 0))         .withColumn('MentionDocTranslationInfo', regexp_replace('MentionDocTranslationInfo', 'srclc:', ''))         .withColumn('MentionDocTranslationInfo', upper('MentionDocTranslationInfo'))
        ...
        mentions_events_gkg_df = mentions_events_gkg_df.withColumn('EventTimeDate', to_timestamp('EventTimeDate', 'yyyyMMddHHmmss'))         .withColumn('MentionTimeDate', to_timestamp('MentionTimeDate', 'yyyyMMddHHmmss'))
