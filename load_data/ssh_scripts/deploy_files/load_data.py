...
def spark_read_csv(spark_session, spark_context, csv_filepath, csv_file_list, schema_dictionary, csv_type):
    ...
    for file in csv_file_list:
        ...
        # read csv
        #df = spark_session.read.options(delimiter='\t').csv('file:///home/ubuntu/deploy_files/'+csv_filepath+file, schema=schema)
...
def load_data(year_list, month_list, day_list, schema_dictionary, spark_session, spark_context, mongodb_database, mongodb_collection, download_csv_path, start_url):
    ...
    print("download_and_extract")
    mentions_df = spark_read_csv(spark_session=spark_session, spark_context=spark_context, csv_filepath=download_csv_path, csv_file_list=mentions_extracted_csvs, schema_dictionary=schema_dictionary, csv_type='mentions')
